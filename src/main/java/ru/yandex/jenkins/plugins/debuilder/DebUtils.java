...
public class DebUtils {
    public static class Runner {
    	...
    	private final static String installOk = "Status: install ok installed";
    	...
    	public boolean isPackageInstalled(String packageName) throws DebianizingException {
    		String command = MessageFormat.format("dpkg -s {0} | grep -e ^Status", packageName);
    		String result = runCommandForOutput(command).trim();
    		return result.equals(installOk);
    	}
    }
}
